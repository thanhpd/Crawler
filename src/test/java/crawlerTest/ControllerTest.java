...
public class ControllerTest {	
    ...
    public static void main(String[] args) throws Exception {    	
        ...
        for(int i = 0; i < numberOfTotalCrawlers; i++) {
        	...
        	CrawlerTest crawler = prop.crawlers.get(i);
         ...
         */
        for(int i = 0; i < numberOfTotalCrawlers; i++) {
        	controller[i].startNonBlocking(MyCrawlerTest.class, prop.crawlers.get(i).getConcurrentThreads());
        }
